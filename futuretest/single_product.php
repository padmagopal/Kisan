            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <!--<li class="active"><a href="single_product.php">Single product</a></li>-->
                                ...
                                <div class="product-images">
                                    <div class="product-main-img">
                                        <?php
                                            ...
                                            while ($row1=mysqli_fetch_array($sta)) 
                                            {
                                                $id=$row1["product_id"];
                                            
                                                if ($prod_id==$id) 
                                                { ?>
                                        <img src="img/<?php echo $row1["product_image"]?>" width="200" height="200" alt="">
                                    <?php }
                                }?>
                                    </div>
                            ...
                            while ($row1=mysqli_fetch_array($sta)) 
                            {
                                ...
                                <div class="product-inner">
                                    ...
                                    <div class="product-inner-price">
                                        <ins>&#x20b9;<?php echo $row1["product_price"]?> </ins> <!--<del>&#x20b9;3000.00</del>-->
                                    </div>    
                                    
                                    <form action="add_cart1.php" class="cart" method="post">
                                        <div class="quantity">
                                            <input type="number" size="4" class="input-text qty text" title="Qty" value="1" name="quantity" min="1" step="1">
                                        </div>

                                        <button class="add_to_cart_button" type="submit" name="addcar" value="<?php echo $prod_id; ?>">Add to cart</button>
                                    </form>   
                                    
                                    <div class="product-inner-category">
                                        <p>Category: <a href=""><?php echo $row1["product_category"]; ?></a>.</p>
                                    </div> 
                                            ...
                                            <div class="product-carousel">
                                                ...
                                                <div class="single-product">
                                                    <div class="product-f-image">
                                                        ...
                                                        <a href="add_cart.php?id=<?php echo $prod_id;?>" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i>Add to cart</a>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="footer-about-us">
                        <h2><span>Future Shopping</span></h2>
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                       <p>&copy; 2019 Future Shopping. All Rights Reserved. 
                    </div>
                </div>
