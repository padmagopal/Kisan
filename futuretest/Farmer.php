                    ...
                    <div class="info-box bg-cyan hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <?php
                                ...
                                ?>
                            <div class="number count-to" data-from="0" data-to="<?php echo $speed; ?>" data-speed="1000" data-fresh-interval="20"><?php echo $speed; ?></div>
                        </div>
                    </div>
                </div>
    ...
    <script src="widget.js"></script>
	  <script>
        var botmanWidget = {
            ...
            introMessage: 'HEY I am your DOST you can ask me about press 1.demand product 2.plant diagnosis',
