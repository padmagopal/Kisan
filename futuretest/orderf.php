                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                     ...
                     <!-- Basic Card -->
                        ...
                        <form action="myorders_track_excel.php" method="post">
                            <div align="right" style="padding-top:3%;padding-right:3%;">
                                <button type="submit" class="btn btn-sm btn-danger" name="excel">Excel</button>
                            </div>
                        </form>
...
while ($row=mysqli_fetch_array($stats))
{
	...
	?> 
                                    ...
                                    <tbody>
                                        ...
                                        <td><?php echo $hno.",".$area.",".$lmark;?></td>
                                        <td><?php echo $total;?></td>
                                        <td><?php echo $seller;?></td>
                                        <td>
                        			      	<div class="form-group">
                        			      		<?php if(($status==0)||($status==1)){ ?>
                        					    <select class="form-control" id="<?php echo $orderid;?>" name="status" onchange="fun1(this.id)">
