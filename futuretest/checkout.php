                ...
                <div class="col-md-8">
                    <div class="product-content-right">
                        <div class="woocommerce">
                            ...
                            <form enctype="multipart/form-data" action="orders.php" class="checkout" method="post" name="checkout">
                                    ...
                                    <div class="col-1">
                                        <div class="woocommerce-billing-fields">
                                            ...
                                            <p id="billing_company_field" class="form-row form-row-wide">
                                                <label class="required" for="billing_company">Company Name</label>
                                            ...
                                            <p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
                                                ...
                                                <input type="text" value="" placeholder="Street address" id="billing_address_1" name="billing_address_1" class="input-text" required>
                                            </p>
                                            ...
                                            <p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
                                                ...
                                                <input type="text" id="billing_state" name="billing_state" placeholder="State " value="" class="input-text">
                                            </p>
                                            <p id="billing_postcode_field" class="form-row form-row-last address-field validate-required validate-postcode" data-o_class="form-row form-row-last address-field validate-required validate-postcode">
                                                <label class="" for="billing_postcode">Postcode <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="text" value="" placeholder="Postcode / Zip" id="billing_postcode" name="billing_postcode" class="input-text" required>
                                            </p>
                        ...
                        <input type="checkbox" value="1" name="ship_to_different_address" checked="checked" class="input-checkbox" id="ship-to-different-address-checkbox">
                                ...
                                <div id="order_review" style="position: relative;">
                                    <table class="shop_table">
                                        ...
                                        <tbody>
                                        <?php if(isset($_SESSION['product_name'])){ for ($i=0; $i <sizeof($_SESSION['product_name']); $i++) { ?>
                                            <tr class="cart_item">
                                                <td class="product-name">
                                                    <?php echo $_SESSION['product_name'][$i];?><strong class="product-quantity">× <?php echo $_SESSION['quantity'][$i+1];?></strong> </td>
                                                <td class="product-total">
                                                    <span class="amount"><?php echo $_SESSION['rate'][$i];?></span> </td>
                                            </tr>
                                     <?php  } } ?>
                                        ...
                                        <tfoot>
                                            ...
                                            <tr class="cart-subtotal">
                                                <th>Cart Subtotal</th>
                                                <td><span class="amount"><?php if(isset($_SESSION['total'])){ echo $_SESSION['total'];} else echo "0" ?></span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr class="order-total">
                                                <th>Order Total</th>
                                                <td><strong><span class="amount"><?php  if(isset($_SESSION['total'])){ echo $_SESSION['total'];} else echo "0" ?></span></strong> </td>
                                            </tr>
