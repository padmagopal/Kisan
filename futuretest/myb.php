...
<section class="content">
       <div class="row clearfix">
                ...
                <?php 
                    $sno=0;
                  include("db.php");
                  $sql="select product_id, sum(total),count(product_id) from order_details where seller='".$_SESSION['email']."' group by product_id Order by sum(total) desc";
              
                  $row=mysqli_fetch_row(mysqli_query($db,$sql));
                
                  $sql2="select product_name from product_details where product_id='".$row[0]."' ";
    ...
    <section class="content">
       <div class="row clearfix">
                ...
                <?php 
                    $sno=0;
                  include("db.php");
                  $sql="select sum(total) from order_details where seller='".$_SESSION['email']."'";
              
                  $row=mysqli_fetch_row(mysqli_query($db,$sql));
                
                  $sql2="select count(*) from order_details where seller='".$_SESSION['email']."'";
