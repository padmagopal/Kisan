                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <div class="form-line">
                                            <input type="text" class="form-control date" name=" account_name" placeholder="Account Holder's Name" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <div class="form-line">
                                            <input type="text" class="form-control date" name="account_number" placeholder="Account No." required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <div class="form-line">
                                            <input type="text" class="form-control date" name="bank_name" placeholder=" Bank Name" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <div class="form-line">
                                            <input type="text" class="form-control date" name="branch_name" placeholder="Branch Name" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <div class="form-line">
                                            <input type="text" class="form-control date" name="ifsc_no" placeholder="IFSC Code" required>
                                        </div>
                                    </div>
                                </div>
                                 <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <div class="form-line">
                                            <input type="text" class="form-control date" name="pancard_name" placeholder="Pan Name" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <div class="form-line">
                                            <input type="text" class="form-control date" name="pancard_num" placeholder="Pan No." required>
                                        </div>
                                    </div>
                                </div>
