...
<section class="content">
 ...
 <tr>   <input type="text" placehoder="title" name="title" style="
    margin-left: 210px;
"></tr>
      <br>
     <tr> <label>Enter the news not more than 500 words</label></tr>
<tr>  <textarea name="news" cols="40" rows="5" style="
    padding-top: 20px;
