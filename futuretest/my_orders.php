            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <?php include("db.php");
                         $sql3="SELECT com from users where email='".$_SESSION['email']."'";
                        ...
                        <ul class="ml-menu">
                            ...
                            <?php
                              if($s==1)
                                 { ?>
                                <a href="amount_business.php">Amount Wisse </a>
                              <?php } ?>
                            </li>
                            <li>
                               <?php if($s==2) { ?>
                                <a href="member_business.php">Member Wise </a>
                              <?php }   ?>
                            </li>
                        </ul>
                    </li>

                     <li class="active"> <a href="my_orders.php"> <i class="material-icons">group</i>
                            <span>My Orders</span>
                        </a>
                    </li>
                     <li> <a href="#"> <i class="material-icons">group</i>
                            <span>About</span>
                        </a>
                    </li>
                </ul>
...
<section class="content">
       <div class="row clearfix">
                ...
                <?php
                  include("db.php");
                  $sql="SELECT user_name,user_id,email,mobile from users where email='".$_SESSION['email']."'";
                  $row=mysqli_fetch_row(mysqli_query($db,$sql));
                  $query="SELECT * from order_details where user_id='".$row[1]."'";
                  $result=mysqli_query($db,$query);
                  while($rows=mysqli_fetch_array($result))
                  {
                      $qr="select product_name from product_details where product_id='".$rows['product_id']."'";
                      $st=mysqli_query($db,$qr);
                      $r1=mysqli_fetch_row($st);
                      $pname=$r1[0];
                      $quan=$rows['quantity'];
                      $hno=$rows['hno'];
                      $street=$rows['street'];
