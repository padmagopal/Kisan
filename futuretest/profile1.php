        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li> <a href="weather_analysis.php"> <i class="material-icons">group</i>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <div class="form-line">
                                            <input type="number" class="form-control date" name="item" placeholder="Mobile(xxxxxx98)" value="<?php echo $row[15];?>" required>
                                        </div>
                                    </div>
                                </div>
