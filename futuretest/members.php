            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li><a href="javascript:void(0);" class="menu-toggle"> Amount Wise Reports</a>
                                <ul class="ml-menu">
                                    <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                     ...
                                     <li>
                                        ...
                                        <ul class="ml-menu">
                                            <li>
                                                <a href="member_paid_reports.php">Unpaid</a>
                                            </li>
                                            <li">
...
while ($row=mysqli_fetch_array($stats))
{
	...
	?> 
                                    ...
                                    <tbody>
                                        ...
                                        <?php 
                                        	include("db.php");
                                        		$que="select * from users where mobile='".$mobile."'";
												$sta=mysqli_query($db,$que);
												while($r=mysqli_fetch_array($sta))
												{
													$status2=$r["status"];
												}
												if ($status2==0) 
                                        ...
                                        <td><form action="activate.php" method="POST">
													...
													<button type="submit" class="btn btn-sm btn-danger" name="hi" value="<?php echo $mobile; ?>">Deactivate</button>
                                        	
                                        			</form>
                                        <!--<form action="activate.php" method="POST">
                                        	<button type="submit" class="btn btn-sm btn-danger" name="hi" value="<?php echo $mobile; ?>" disabled>Activate</button>
                                        ...
                                        <form action="activate.php" method="POST">
                                        	<button type="submit" class="btn btn-sm btn-danger" name="hi" value="<?php echo $mobile; ?>">Activate</button>
                                        ...
                                        <td><form action="profile.php" action="POST">
